...
paste -d ";" country.txt id.txt year.txt | sort > order_country.txt
#paste the columns, order by country and create an output file
paste -d ";" year.txt id.txt country.txt | sort > order_year.txt
#remove the medium o intermediated files
